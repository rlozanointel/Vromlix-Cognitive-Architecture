...
# -*- coding: utf-8 -*-
# @description Motor de auto-indexación SOTA que escanea el ecosistema Vromlix, extrae metadatos y utiliza Gemini para generar descripciones de archivos, actualizando el índice JSON maestro e inyectando metadatos faltantes en notas.
"""
VROMLIX PHASE 2: Auto-Indexer & AI Librarian (v3.2 SOTA)
Ahora soporta traducción de abstracts de Obsidian e inyección automática de metadatos en archivos .md.
"""
...
# Inyección transversal para localizar el Orquestador
# sys.path.append("/media/rogerman/14befb81-4210-4134-a9a0-0ee76166e483/VROMLIX_CORE")
...
def extract_cognitive_core() -> dict:
    # 1. Intentar rescatar la filosofía del Súper-Índice JSON actual (Independencia del XML)
    ...
    # 2. Si no hay JSON, intentar con el XML viejo
